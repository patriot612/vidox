...
VidoX (`@V1doXBot`) downloads **public** videos from TikTok, Instagram Reels,
and YouTube Shorts and delivers them straight into a Telegram chat as native video
...
- Media extraction: [yt-dlp](https://github.com/yt-dlp/yt-dlp) (actively
  maintained, supports TikTok/Instagram Reels/YouTube Shorts public content)
...
└── src/
    ...
    │   ├── message.ts             # URL detection, YouTube Shorts download
    ...
    │   ├── pendingPreviews.ts     # legacy preview token storage
...
TikTok/Instagram Reels/YouTube Shorts), so no inbound port needs to be opened for the
...
- **YouTube Shorts**: only `/shorts/...` URLs are accepted. The best public
  video/audio combination is downloaded directly; there is no quality picker
  and no intentional re-encoding. Long-form YouTube URLs are rejected.
